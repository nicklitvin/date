...
//     await Promise.all( Object.keys(userAttributes).map( (val) => 
//         prismaManager.addNewAttributeEntry(val as AttributeType)
//     ))

//     for (let type of Object.keys(userAttributes) as AttributeType[]) {
//         for (let value of userAttributes[type]) {
//             expect(await prismaManager.addAttributeValue(type,value)).not.toEqual(null);
//         }
//     }
// }
